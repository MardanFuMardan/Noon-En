     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any issues you have encountered. Please note that Noon provides a grace period for returns of 15 days from the date of receiving the product if the product is returnable for new products, and 7 days for refurbished products if you received it with a problem or did not like it and it was not as described.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nPlease note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nThe order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days, after which the amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nYou can easily raise a return request for returnable products by following these steps:\n\n1- Open the Noon app or website and click on \"My Account\", then click on the \"Return\" option from the menu.\n2- Click on \"Return\", then \"Create a new return request\".\n3- Select the product you wish to return.\n4- Choose the reason for return.\n5- Choose the specific reason for return (if any).\n6- Add any additional comments - the more details, the better.\n7- Answer the questions to determine the condition of the return product.\n8- Add photos of the product condition.\n9- Choose your pickup address or select the default address.\n10- Accept the return policy declaration.\n11- Submit the return request.\n\nFor further assistance, feel free to contact our customer service team at: Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Offer Return For Prepaid",
  "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience you faced. Please note that Noon offers a return grace period of 15 days from the product receipt date for new products if they are returnable, and 7 days for renewed products if you received a defective or unsatisfactory item that does not match the description.\n\nPlease ensure the product is returned in its original packaging, is not damaged, and remains unused with all labels intact. For more details about the return policy, please review the following link: https://www.noon.com/egypt-ar/return-policy.\n\nOnce a return request is made, a message with the shipping waybill number will be sent to you. Before pickup, the delivery agent may ask you to confirm the return number message sent to you.\n\nThe item will be collected from you within 2 to 3 working days, then arrive to us within 4 to 6 working days. Quality inspection will take place within 2 working days, after which the refund will be processed if the item passes the quality check.\n\nYou will receive a message when the agent is on the way to pick up the return.\n\nPlease note that if payment was made by card, the refund will first be issued to your Noon wallet, then automatically transferred to your bank account after 24 hours, and it will take 5 to 7 working days depending on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nYou can easily submit a return request for returnable products by following these steps:\n\n1- Open the Noon app or website and click on \"My Account\", then choose the Return option from the menu.\n2- Click on \"Return\", then \"Create New Return Request\".\n3- Select the product to be returned.\n4- Choose the reason for the return.\n5- Choose the specific additional reason for return (if any).\n6- Add any additional comments - the more details, the better.\n7- Answer questions to determine the condition of the return product.\n8- Add photos of the product condition.\n9- Choose your pickup address or select the primary address.\n10- Accept the return policy declaration.\n11- Submit the return request.\n\nFor further assistance, feel free to contact our customer service team at: Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Offer Return For Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any issues you have encountered. Please note that Noon provides a grace period for returns of 15 days from the date of receiving the product if the product is returnable for new products, and 7 days for refurbished products if you received it with a problem or did not like it and it was not as described.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nPlease note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nThe order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days, after which the amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Valu, the refund will be made directly to the source of payment (Valu).\n\nYou can easily raise a return request for returnable products by following these steps:\n\n1- Open the Noon app or website and click on \"My Account\", then click on the \"Return\" option from the menu.\n2- Click on \"Return\", then \"Create a new return request\".\n3- Select the product you wish to return.\n4- Choose the reason for return.\n5- Choose the specific reason for return (if any).\n6- Add any additional comments - the more details, the better.\n7- Answer the questions to determine the condition of the return product.\n8- Add photos of the product condition.\n9- Choose your pickup address or select the default address.\n10- Accept the return policy declaration.\n11- Submit the return request.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Offer Return For Noon Credit",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any issues you have encountered. Please note that Noon provides a grace period for returns of 15 days from the date of receiving the product if the product is returnable for new products, and 7 days for refurbished products if you received it with a problem or did not like it and it was not as described.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nPlease note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nThe order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days, after which the amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Noon Credit, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish. You can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nYou can easily raise a return request for returnable products by following these steps:\n\n1- Open the Noon app or website and click on \"My Account\", then click on the \"Return\" option from the menu.\n2- Click on \"Return\", then \"Create a new return request\".\n3- Select the product you wish to return.\n4- Choose the reason for return.\n5- Choose the specific reason for return (if any).\n6- Add any additional comments - the more details, the better.\n7- Answer the questions to determine the condition of the return product.\n8- Add photos of the product condition.\n9- Choose your pickup address or select the default address.\n10- Accept the return policy declaration.\n11- Submit the return request.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nAfter tracking your return request, the order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days.\n\nThe amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Track Normal Return Not Picked Prepaid",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nAfter tracking your return request, the order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days.\n\nThe amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via card, the amount will be refunded to your Noon wallet, and then it will be automatically transferred to your bank account after 24 hours, and it will take a period of 5 to 7 working days depending on the bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that after tracking your return request, it has been picked up from you on (_______).\n\nThen the order will reach us within 4 to 6 working days, and quality inspection will be conducted within 2 working days.\n\nThe amount will be refunded to your account if the order passes the quality inspection process.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any issues you have encountered. Please note that Noon provides a grace period for returns of 15 days from the date of receiving the product if the product is returnable for new products, and 7 days for refurbished products if you received it with a problem or did not like it and it was not as described.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nPlease note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nIf you agree to the return request, the order will be picked up from you within 3 working days. A request will also be raised to approve the refund, and it will be processed within a maximum of 2 days. You will be contacted via email or phone after the request is approved.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nYou can easily raise a return request for returnable products by following these steps:\n\n1- Open the Noon app or website and click on \"My Account\", then click on the \"Return\" option from the menu.\n2- Click on \"Return\", then \"Create a new return request\".\n3- Select the product you wish to return.\n4- Choose the reason for return.\n5- Choose the specific reason for return (if any).\n6- Add any additional comments - the more details, the better.\n7- Answer the questions to determine the condition of the return product.\n8- Add photos of the product condition.\n9- Choose your pickup address or select the default address.\n10- Accept the return policy declaration.\n11- Submit the return request.\n\nFor further assistance, feel free to contact our customer service team at: Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nAfter tracking your return request, the order will be picked up from you within 3 working days. A request has also been raised to approve the refund and has been updated by me, and it will be processed within a maximum of 2 days. You will be contacted via email or phone after the request is approved.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that after tracking your return request, it has been picked up from you on (_______).\n\nA request has also been raised to approve the refund and has been updated by me, and it will be processed within a maximum of 2 days. You will be contacted via email or phone after the request is approved.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link:\nhttps://www.noon.com/egypt-ar/return-policy.\n\nAfter tracking your return request, the order will be picked up from you within 3 days, then the return will reach the seller and the refund will be processed within a period of 5 to 7 days.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that after tracking your return request, it has been picked up from you on (_______).\n\nThen the return will reach the seller and the refund will be processed within a period of 5 to 7 days.\n\nPlease note that when paying via Cash on Delivery, the refund will be made to your Noon wallet.\n\nPlease note that your Noon balance is valid for a lifetime and can be used to place a new order if you wish.\n\nYou can use it after selecting the address and while choosing the payment method by checking the box labeled (Use my Noon balance).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your inquiry about order number (_______) and canceling the return request, please note that you can cancel the return request by logging into your account, then going to (Return), selecting the order, then clicking on (Manage Return Request), and finally clicking on (Cancel Return).\n\nFor further assistance, feel free to contact our customer service team via email: Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
...
/* Refund */
{
 ...
 "tabs": [
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that the amount has been issued to your Noon wallet on (________), and after 24 hours, an automatic transfer request will be created for your bank account, which will be processed within 5 to 7 working days, depending on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Amount Transferred",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that the amount has been automatically transferred to your bank account on (________), and it will be processed within 5 to 7 working days, depending on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
  ...
  "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), you can request to transfer the amount to your bank account by accessing the Noon website (not the app), then selecting \"My Account\", then \"Noon Balance\", and then choosing \"Transfer Balance\".\n\nPlease ensure to follow these steps via the website or mobile browser, as the service is currently not available through the app.\n\nWhen selecting \"Transfer Balance\", you will be asked to provide your bank account details for the transfer.\n\nPlease make sure to enter the required bank account information completely and correctly, including your full name.\n\nA text message containing a code will be sent to the phone number registered with your Noon account. Please enter it in the specified field to confirm the request, then an email will be sent allowing you to confirm or cancel the request.\n\nPlease note the email confirmation is valid for one hour. If not confirmed, the request will be automatically rejected and the confirmation link will expire.\n\nThe balance will be deducted from your wallet. Within 4 to 5 hours, the status will update to \"Processing\" where the request execution begins.\n\nThe transfer will be completed within 5 to 7 working days according to your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nYou can transfer amounts from your Noon balance using this service once every 15 days. Also, please note that the total amount transferred in one operation must be between 200 EGP and 10,000 EGP.\n\nYou can track the transfer process by going to \"My Account\", then \"Noon Balance\", and then clicking on \"Transfers\".\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Offer Refund Request",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that you can create a request to transfer the amount through us if you wish, and the amount will be transferred to your bank account within 5 to 7 working days, depending on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Change In Refund Mode Raised",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that a request to transfer the amount has been created, and an email has been sent to the email address registered with your Noon account. Please fill in all the required details and send them to the mentioned email, which is \"refunds@noon.com.\"\n\nPlease ensure that all required bank account details are entered completely and correctly, and the full name must be provided.\n\nPlease note that if no response is received to the sent email within 72 hours, the transfer request will be closed.\n\nThis request will be pending approval for 24 to 48 hours after you send the correct and complete bank details.\n\nPlease note that this request may take 5 to 7 working days, depending on the bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nIf there is a discrepancy between the \"bank account holder's name\" sent to us and the \"Noon account holder's name,\" responding to the email will be considered as confirmation for us to proceed with the bank transfer for the mentioned account.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Change In Refund Mode Follow up",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that the transfer request submitted with the details sent by you has been updated.\n\nThis request will be pending approval for 24 to 48 hours after you send the correct and complete bank details.\n\nPlease note that this request may take 5 to 7 working days, depending on the bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nIf there is a discrepancy between the \"bank account holder's name\" sent to us and the \"Noon account holder's name,\" responding to the email will be considered as confirmation for us to proceed with the bank transfer for the mentioned account.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Raised Prepaid Request",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), please note that a request has been created to transfer the amount to your payment source. Please note that the processing time for transferring the amount to your bank account ranges between 5 to 7 working days, depending on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (_____), please note that the amount has been added to your Noon balance on (_____) as the payment was made via Cash on Delivery.\n\nPlease note that your Noon balance is valid for a lifetime, and you can use it to place a new order if you wish.\n\nYou can use it after selecting the address and during the payment method selection by checking the box labeled \"Use My Noon Balance.\"\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Noon Credit Refunded",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (_____), please note that the amount has been added to your Noon balance on (_____) as the payment was made via Noon Credit.\n\nPlease note that your Noon balance is valid for a lifetime, and you can use it to place a new order if you wish.\n\nYou can use it after selecting the address and during the payment method selection by checking the box labeled \"Use My Noon Balance.\"\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       {
         "heading": "Valu Refund",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (_____), please note that the payment was made via Valu.\n\nPlease note that when paying via \"Valu,\" the amount will be refunded directly to the payment source (\"Valu\").\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
     {
...
"content": "Hala,\n\nThank you for choosing Noon!\n\nTo track the status of the refunded amount, you can obtain the Refund Reference Number (RRN) to follow up with your bank.\n\nThis can be done by going to \"My Account,\" selecting the order from the \"Orders\" section, then choosing \"View Refund Tracking Number.\"\n\nIf you used Noon credits for the payment, the refund details will appear, and you can click on \"View Noon Credits\" to go directly to the wallet page.\n\nIn some rare cases, you may see a message asking you to contact customer support to track the refund. This may happen in cases such as:\n\nRefund of installments from the National Bank of Egypt (NBE)\n\nOr an issue with the refund process from the bank\n\nSometimes, the refund may remain pending in the following situations:\n\nIf the product was not delivered.\n\nIf \"Cancel Shipment\" was selected.\n\nIf the item was canceled in its early processing stage.\n\nWe also have a detailed refund breakdown page accessible through the link on the word \"here\" in the completed refund section, showing which items/fees were refunded.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
     ]
   },
   {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), please note that an attempt was made to transfer the amount to your bank account as follows:\n\nThe amount was added to your Noon balance on (____).\n\nIt was transferred to your bank account on (____).\n\nThe transfer was rejected by your bank, and the amount was returned to your Noon balance on (____).\n\nWe advise you to contact your bank to resolve the issue, as the transfer was successfully processed by Noon but rejected by your bank.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
...
"content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), we deeply regret what happened. Please note that according to our records, your order was canceled on (____), and no amount was deducted from your bank account at that time.\n\nIf a deduction appears on your bank account, it should be automatically refunded within 5 to 7 working days, according to your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nIf the problem persists, please contact your bank for further clarification, as the deduction was not made by Noon.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."       },
       {
         "heading": "Cancel Authorized All Order After SLA",
"content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), we deeply regret what happened. Please note that according to our records, your order was canceled on (____), and no amount was deducted from your bank account at that time.\n\nIf a deduction appears on your bank account, it should have been automatically refunded within 5 to 7 working days, according to your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nSince the amount was deducted and has not been refunded within the stated period, please contact your bank to cancel the payment, as the deduction was not made by Noon.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."       },
       {
         "heading": "Cancel Authorized Item From The Order",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), we deeply regret what has happened. Please note that according to our records, your product was canceled on (____), and at this time, no amount has been deducted from your bank account by Noon.\n\nOnce the entire order reaches the \"Shipped\" status, the amount will be automatically reversed to your bank account (your payment source).\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nTo proceed, please provide us with the reason for cancellation to be applied to the order.\n\nPlease note that if you have used a discount coupon within the order, it may not be reusable.\n\nTo confirm the cancellation and process your request as soon as possible, please reply to this email with your confirmation.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and the order has already been canceled based on your request.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Exported / Exported With AWB Prepaid",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and the order has already been canceled based on your request.\n\nAfter cancellation, the funds will be added to your Noon balance, and after 24 Hours, an automatic transfer request will be created to your bank account, and it will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Exported / Exported With AWB Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and the order has already been canceled based on your request.\n\nPlease note that when paying via \"Valu\", the funds will be returned directly to the payment source (\"Valu\").\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Exported / Exported With AWB Noon Credit",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and the order has already been canceled based on your request.\n\nPlease note that when paying via Noon Credit, the refund will be made to your Noon Wallet.\n\nPlease note that Noon Credit is valid for a lifetime, and you can use it to create a new order if you wish.\n\nYou can use it after selecting the address and during the payment method selection, by checking the box labeled (Use My Noon Credit).\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cx Already Canceled Exported COD",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cx Already Canceled Exported Prepaid Auto Transfer Not Done",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nRegarding the funds, please note that they will be added to your Noon balance, and after 24 Hours, an automatic transfer request will be created to your bank account, and it will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cx Already Canceled Exported Prepaid Auto Transfer Done",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we understand your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nRegarding the funds, please note that an automatic transfer request to your bank account was created on (____), and it will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nPlease note that after review, it was found that the order contains a discount coupon, and if you have used a discount coupon within the order, it may not be reusable.\n\nTo confirm the cancellation and process your request as soon as possible, please reply to this email with your confirmation.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cancel Shipped Asking QS / With Coupon / Prepaid",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nPlease note that after review, it was found that the order contains a discount coupon, and if you have used a discount coupon within the order, it may not be reusable.\n\nTo confirm the cancellation and process your request as soon as possible, please reply to this email with your confirmation.\n\nPlease note that when paying via card, the amount will be refunded to your Noon Wallet, and then it will be automatically transferred to your bank account after 24 Hours, and it will take 5 to 7 working days based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nPlease note that after review, it was found that the order contains a discount coupon, and if you have used a discount coupon within the order, it may not be reusable.\n\nTo confirm the cancellation and process your request as soon as possible, please reply to this email with your confirmation.\n\nPlease note that when paying via Noon Credit, the refund will be made to your Noon Wallet.\n\nPlease note that Noon Credit is valid for a lifetime, and you can use it to create a new order if you wish.\n\nYou can use Noon Credit after selecting the address and during the payment method selection, by checking the box labeled (Use My Noon Credit).\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Shipped COD",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Shipped Prepaid",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, when paying via card, the amount will be refunded to your Noon Wallet within a maximum of one day.\n\nThen it will be automatically transferred to your bank account after 24 Hours, and it will take 5 to 7 working days based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Shipped Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded within a maximum of one day, as when paying via \"Valu\", the funds are returned directly to the payment source (\"Valu\").\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Shipped Noon Credit",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded to your Noon Wallet within a maximum of one day.\n\nPlease note that when paying via Noon Credit, the amount remains in your Noon Wallet.\n\nPlease note that Noon Credit is valid for a lifetime, and you can use it to create a new order if you wish.\n\nYou can use Noon Credit after selecting the address and during the payment method selection, by checking the box labeled (Use My Noon Credit).\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cx Already Canceled Shipped COD",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, when paying via card, the amount will first be refunded to your Noon Wallet within a maximum of one day. After review, it has been confirmed that this has already been done, and an automatic transfer request to your bank account was created on (____).\n\nIt will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nAfter reviewing your order, it was found that the shipment is being delivered via J&T Express. To cancel the shipment, please inform the delivery agent when they contact you.\n\nPlease note that the cancellation status will appear in your account once the product reaches Noon's warehouses.\n\nWe would also like to inform you that the cancellation process may take up to a maximum of 30 days to be completed.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel J&T Express Shipped Prepaid",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nAfter reviewing your order, it was found that the shipment is being delivered via J&T Express. To cancel the shipment, please inform the delivery agent when they contact you.\n\nPlease note that the cancellation status will appear in your account once the product reaches Noon's warehouses.\n\nWe would also like to inform you that the cancellation process may take up to a maximum of 30 days to be completed.\n\nAfter the cancellation is completed, the funds will be added to your Noon balance, and after 24 Hours, an automatic transfer request will be created to your bank account, and it will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel J&T Express Shipped Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nAfter reviewing your order, it was found that the shipment is being delivered via J&T Express. To cancel the shipment, please inform the delivery agent when they contact you.\n\nPlease note that the cancellation status will appear in your account once the product reaches Noon's warehouses.\n\nWe would also like to inform you that the cancellation process may take up to a maximum of 30 days to be completed.\n\nAfter the cancellation is completed, when paying via \"Valu\", the funds will be returned directly to the payment source (\"Valu\").\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel J&T Express Shipped Noon Credit",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we regret to hear about your desire to cancel, and we respect your decision.\n\nAfter reviewing your order, it was found that the shipment is being delivered via J&T Express. To cancel the shipment, please inform the delivery agent when they contact you.\n\nPlease note that the cancellation status will appear in your account once the product reaches Noon's warehouses.\n\nWe would also like to inform you that the cancellation process may take up to a maximum of 30 days to be completed.\n\nAfter the cancellation is completed, when paying via Noon Credit, the refund will be made to your Noon Wallet.\n\nPlease note that Noon Credit is valid for a lifetime, and you can use it to create a new order if you wish.\n\nYou can use it after selecting the address and during the payment method selection, by checking the box labeled (Use My Noon Credit).\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, when paying via card, the amount will be refunded to your Noon Wallet within a maximum of 3 days.\n\nThen it will be automatically transferred to your bank account after 24 Hours, and it will take 5 to 7 working days based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Direct Delivery Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded within a maximum of 3 days, as when paying via \"Valu\", the funds are returned directly to the payment source (\"Valu\").\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Taking Action To Cancel Direct Delivery Noon Credit",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel and confirm that the cancellation request has been successfully executed.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded to your Noon Wallet within a maximum of 3 days.\n\nPlease note that when paying via Noon Credit, the amount remains in your Noon Wallet.\n\nPlease note that Noon Credit is valid for a lifetime, and you can use it to create a new order if you wish.\n\nYou can use Noon Credit after selecting the address and during the payment method selection, by checking the box labeled (Use My Noon Credit).\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we appreciate your desire to cancel, and upon review, it has been confirmed that the order was already canceled by you.\n\nIn case the delivery agent contacts you because the order is in transit, you can inform them of your desire not to receive the order.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, when paying via card, the amount will first be refunded to your Noon Wallet within a maximum of 3 days. After review, it has been confirmed that this has already been done, and an automatic transfer request to your bank account was created on (____).\n\nIt will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nWe would like to point out that after cancellation, it will not be possible to reship or redeliver the order. However, if you wish to obtain these products again, you can easily create a new order.\n\nYou can also cancel the order yourself through your Noon account by:\n\nLogging into your account.\n\nClicking on \"My Account\" > \"Orders\".\n\nSelecting the desired product and then canceling it using the available cancellation option.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the requested product is out of stock, which forced us to cancel the order.\n\nWe tried to provide alternative options from other sellers to fulfill your order, but unfortunately, we were unable to provide the requested product in this case.\n\nWe appreciate your understanding and are working hard to ensure the availability of the products you desire in the future.\n\nOnce the product is available again, you will be able to easily place a new order as per your wish.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Canceled As Out Of Stock Inform Cx Prepaid Authorized",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the requested product is out of stock, which forced us to cancel the order.\n\nWe tried to provide alternative options from other sellers to fulfill your order, but unfortunately, we were unable to provide the requested product in this case.\n\nWe appreciate your understanding and are working hard to ensure the availability of the products you desire in the future.\n\nOnce the product is available again, you will be able to easily place a new order as per your wish.\n\nYour order was canceled on (____), and at this time, no amount has been deducted from your bank account.\n\nIn case a deduction has appeared on your bank account, the amount is expected to be automatically refunded within 5 to 7 working days, in accordance with the bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nIf the issue persists, please contact your bank for further clarification, as the deduction was not made by Noon.\n\nWe thank you for your understanding and always look forward to serving you better.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the order has been canceled due to the presence of several similar orders placed from different accounts belonging to you.\n\nIn our commitment to fairness and to allow all our valued customers to benefit from our offers, a maximum purchase limit is set for each customer. This measure aims to ensure that as many customers as possible can benefit from our products and exclusive offers.\n\nFor more details, you can refer to clause 2.8 of the Terms of Sale available on our website, which states:\n\n\"Bulk and Multiple Purchases: We reserve the right to reject any orders at our sole discretion in the event of bulk or multiple purchases of similar products.\"\n\nWe thank you for your understanding and always look forward to serving you better.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nThank you for contacting us regarding order number (______), we sincerely apologize for the issue you faced with the order cancellation.\n\nWe assure you that we are always striving to improve our services to ensure a distinguished experience that meets the expectations of our valued customers.\n\nWe would like to inform you that the order has been canceled due to the presence of several similar orders placed from different accounts belonging to you.\n\nIn our commitment to fairness and to allow all our valued customers to benefit from our offers, a maximum purchase limit is set for each customer. This measure aims to ensure that as many customers as possible can benefit from our products and exclusive offers.\n\nFor more details, you can refer to clause 2.8 of the Terms of Sale available on our website, which states:\n\n\"Bulk and Multiple Purchases: We reserve the right to reject any orders at our sole discretion in the event of bulk or multiple purchases of similar products.\"\n\nIn appreciation of your dissatisfaction with this cancellation, we would like to inform you that the complaint related to this issue has been escalated to the concerned department, with all the details related to it to ensure proper handling of the matter.\n\nYou will be provided with updates within a maximum of (two days) from the date of submitting the complaint.\n\nThe concerned department will investigate and resolve the matter, and you will be contacted.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the order has been canceled due to the shipment being damaged and not meeting the quality standards we always strive to achieve.\n\nOur goal is to provide an excellent service and ensure that your orders arrive in the best possible condition. We appreciate your understanding and are working hard to enhance your experience with us in the future.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nPlease note that after canceling the order, it will not be possible to reship or redeliver it. However, you can easily create a new order to obtain the products you desire.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the order has been canceled due to the shipment being damaged and not meeting the quality standards we always strive to achieve.\n\nOur goal is to provide an excellent service and ensure that your orders arrive in the best possible condition. We appreciate your understanding and are working hard to enhance your experience with us in the future.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded to your Noon Wallet within a maximum of 3 days after the cancellation is reflected in your account.\n\nAfter review, it has been confirmed that this has already been done, and an automatic transfer request to your bank account was created on (____).\n\nIt will be processed within 5 to 7 working days, based on your bank's policy.\n\nPlease note that business days do not include holidays and official days off like Friday and Saturday.\n\nTo track the refund status, you can obtain the Refund Reference Number (RRN) to follow up on the refund with your bank.\n\nThis can be done by going to \"My Account\", then selecting the order from the \"Orders\" section, and then choosing \"View Refund Tracking Number\".\n\nWe also have a detailed refund page that can be accessed via the link on the word \"here\" in the Completed Refund section, which explains the products/fees that were refunded.\n\nPlease note that after canceling the order, it will not be possible to reship or redeliver it. However, you can easily create a new order to obtain the products you desire.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Canceled Without Notifying Cx Inform Valu",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (____), we apologize for any inconvenience caused. After reviewing your order, we would like to inform you that the order has been canceled due to the shipment being damaged and not meeting the quality standards we always strive to achieve.\n\nOur goal is to provide an excellent service and ensure that your orders arrive in the best possible condition. We appreciate your understanding and are working hard to enhance your experience with us in the future.\n\nPlease note that the cancellation status will be reflected in your account once the product is received in our warehouses.\n\nAs for the paid amount, it will be refunded within a maximum of 3 days after the cancellation is reflected in your account, as when paying via \"Valu\", the funds are returned directly to the payment source (\"Valu\").\n\nPlease note that after canceling the order, it will not be possible to reship or redeliver it. However, you can easily create a new order to obtain the products you desire.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nThank you for contacting us regarding order number (______), we sincerely apologize for the issue you faced with the order cancellation.\n\nWe assure you that we are always striving to improve our services to ensure a distinguished experience that meets the expectations of our valued customers.\n\nWe would like to inform you that the order has been canceled due to the shipment being damaged and not meeting the quality standards we always strive to achieve.\n\nIn appreciation of your dissatisfaction with this cancellation, we would like to inform you that the complaint related to this issue has been escalated to the concerned department, with all the details related to it to ensure proper handling of the matter.\n\nYou will be provided with updates within a maximum of (two days) from the date of submitting the complaint.\n\nThe concerned department will investigate and resolve the matter, and you will be contacted.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       }
     ]
   },
   {
