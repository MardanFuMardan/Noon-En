   ...
   },
   {
     ...
     "templates": [
       ...
       },
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding your order number (_______), we apologize for any issues you have encountered. Please note that once a return request is made, a message will be sent to you with the shipment bill number. Please note that before pickup, the representative may ask you to confirm the message containing the return number that was sent to you.\n\nPlease ensure that the product is delivered in its original packaging and that the product is not damaged. Also, please do not use the product and ensure that all labels are on the package. For more details on the return policy, please refer to the following link: https://www.noon.com/egypt-ar/return-policy.\n\nAfter tracking your return request, the order will be picked up from you within 2 to 3 working days, then the order will reach us within 4 to 6 working days. Quality inspection will be conducted within 2 working days.\n\nThe amount will be refunded to your account if the order passes the quality inspection process.\n\nYou will receive a message when the representative is on their way to you to pick up the return.\n\nPlease note that when paying via card, the amount will be refunded to your Noon wallet, and then it will be automatically transferred to your bank account after 24 hours, and it will take a period of 5 to 7 working days depending on the bank's policy.\n\nPlease note that working days do not include holidays and official holidays such as Friday and Saturday.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (________), you can request to transfer the amount to your bank account by logging into Noon's website (not the app), then selecting \"My Account,\" followed by \"Noon Balance,\" and then choosing \"Transfer Balance.\"\n\nPlease ensure to follow these steps via the website or mobile browser, as the service is currently unavailable through the app.\n\nWhen selecting \"Transfer Balance,\" you will be asked to attach your bank account details for the transfer.\n\nPlease ensure that all required bank account details are entered completely and correctly, including the full name.\n\nA text message containing a code will be sent to the phone number registered with your Noon account to complete the process. Please enter this code in the designated field to confirm the request, after which an email will be sent allowing you to confirm or cancel the request.\n\nPlease note that the received email is valid for one hour. If not confirmed, the request will be automatically rejected, and the confirmation via email will expire.\n\nThe transfer will be processed within 5 to 7 working days, depending on your bank's policy.\n\nPlease note that working days do not include official holidays such as Friday and Saturday.\n\nYou can transfer amounts from your Noon balance using this service once every 15 days. Please also note that the total amount transferred in the process must range between 200 EGP to 10,000 EGP.\n\nYou can track the transfer process by logging into \"My Account,\" then \"Noon Balance,\" and clicking on \"Transfers.\"\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
     ...
     "templates": [
       {
         ...
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), we deeply regret what has happened. Please note that according to our records, your order was canceled on (____), and at this time, no amount has been deducted from your bank account.\n\nIn case a deduction has appeared on your bank account, the amount is expected to be automatically refunded within 5 to 7 working days, in accordance with the bank's policy.\n\nTherefore, we kindly ask you to wait until this period has passed and review your bank statement again.\n\nPlease note that working days do not include official holidays and weekends such as Friday and Saturday.\n\nIf the issue persists, please contact your bank for further clarification, as the deduction was not made by Noon.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
         "heading": "Cancel Authorized All Order After SLA",
         "content": "Hala,\n\nThank you for choosing Noon!\n\nRegarding order number (____), we deeply regret what has happened. Please note that according to our records, your order was canceled on (____), and at this time, no amount has been deducted from your bank account.\n\nIn case a deduction has appeared on your bank account, the amount was expected to be automatically refunded within 5 to 7 working days, in accordance with the bank's policy.\n\nPlease note that working days do not include official holidays and weekends such as Friday and Saturday.\n\nSince the amount has been deducted and not refunded to you within the specified period, please contact your bank to cancel the payment, as the deduction was not made by Noon.\n\nFor further assistance, feel free to contact our customer service team at Egypt@noon.com.\n\nThank you,\nNoon Team."
       },
       {
...
"content": "If a customer is following up on a closed complaint or request, and you are providing them with the latest update or asking them to wait for a specific time to contact, and the response to the CX is not related to any previous Noon Care Issue, in this case, the Noon Care Issue should be set as **Follow Up Complaint or Request**.\n\nHowever, if, for example, the customer is following up on a request related to a refund, such as a credit to card refund, then the Noon Care Issue can be either Follow Up Complaint or Request or Refund Related. It is more appropriate to set it as Refund Related."		  },
 ...
 /* Queries */
   {
   title: "Queries", // عنوان الصفحة
   icon: "fas fa-database", // أيقونة الصفحة
   tabs: [] // بدون تابات
 },
